                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php endif; ?>
                                        <div class="col-6">
                                            <h4 class="card-title">Daftar Barang Habis Pakai</h4>
                                            <p class="card-title-desc">Data barang habis pakai pada <strong><?= $nama_lab['nama_lab'] ?></strong>.
                                            </p>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <?php if ($this->session->login['role_id'] == 'laboran') : ?>
                                                ...
                                                <a class="btn btn-info btn-sm edit float-end mx-1" data-bs-toggle="modal" data-bs-target="#uploadBhp-modal">
                                                    <i class="mdi mdi-file-upload me-1"></i>Upload Data Barang
                                                </a>
                                            <?php endif; ?>
                                            <a class="btn excel-button btn-sm edit float-end mx-1" href="<?= base_url('index.php/excel/exportBhp/') . $thisLab ?>">
                                    ...
                                    <!-- Modal start -->
                                    <div class="modal modal-lg fade" id="uploadBhp-modal" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!-- Start form input -->
                                                    <form class="row g-3" method="POST" action="<?= base_url('index.php/excel/importBhp') ?>" enctype="multipart/form-data">
