                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            <h3 class=""><?= $detail_ruang['nama_ruangan'] ?></h3>
                                            <p class="badge bg-primary mx-2 mt-1"><?= $detail_ruang['nama_lab'] ?></p>
                                        </div>

                                        <div class="d-inline-flex">
                                            <div class="text-muted ms-3 mt-1">
                                                Created At
                                                <?= date('d/m/Y', $detail_ruang['created_at']) ?>
                                            </div>
                                            <div class="text-muted ms-3 mt-1">
                                                |
                                            </div>
                                            <div class="text-muted ms-3 mt-1">
                                                Updated At
                                                <?= date('d/m/Y', $detail_ruang['updated_at']) ?>
                                            </div>
                                            <div class="ms-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                                    <div class="ms-2">
                                                        <div class="fw-bold">Kontak Penanggung Jawab</div>
                                                        <?= $pic_ruang['kontak'] ?>
                                                    </div>
                                                    <div class="ms-2">
                                                        |
