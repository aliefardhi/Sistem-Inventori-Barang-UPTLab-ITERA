                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <?php endif; ?>
                                        <div class="col-6">
                                            <h4 class="card-title mb-3">Pilih Laboratorium</h4>
                                        </div>
                                    </div>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php foreach ($all_lab as $l) : ?>
                                                <tr>
                                                    <td><?= $no++ ?></td>
                                                    <td><?= $l->nama_lab ?></td>
                                                    <td>
                                                        <a class="btn btn-primary btn-sm edit" title="Pilih" href="<?= base_url('index.php/admin/pilihruanganbaranghilang/') . $l->id_lab ?>">
                                                            Pilih
                                                        </a>
                                                    </td>
                                                </tr>
