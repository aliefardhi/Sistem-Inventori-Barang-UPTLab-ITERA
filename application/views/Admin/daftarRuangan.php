                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <a class="btn btn-primary btn-sm edit float-end" data-bs-toggle="modal" data-bs-target="#tambahRuanganAdmin-modal" href="<?= base_url() ?>index.php/admin/">
                                        ...
                                        <tbody>
                                            <?php foreach ($all_ruangan as $r) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $r->nama_lab ?></td>
                                                    <td>
                                                        <a class="btn btn-primary btn-sm edit" title="Detail" href="<?= base_url('index.php/admin/detailruangan/') . $r->id_ruang ?>">
                                                            <i class="mdi mdi-information-outline"></i>
                                                        </a>
                                                        <a class="btn btn-info btn-sm edit" title="Edit Data" href="<?= base_url('index.php/admin/editdataruangan/') . $r->id_ruang ?>">
                                    ...
                                    <!-- Modal start -->
                                    <div class="modal modal-lg fade" id="tambahRuanganAdmin-modal" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!-- Start form input -->
                                                    <form class="row g-3" method="POST" action="<?= base_url('index.php/admin/daftarruangan') ?>">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <select id="laboratorium" class="form-select" name="laboratorium">
                                                                <option selected>- Pilih -</option>
                                                                <?php foreach ($laboratorium as $l) : ?>
                                                                    <option value="<?= $l->id_lab ?>"><?= $l->nama_lab ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                            <?= form_error('laboratorium', '<small class="text-danger pl-3">', '</small>'); ?>
                                                        </div>
                                                        <div class="col-md-3">
