                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Start form input -->
                                    <form class="row g-3" method="POST" action="<?= base_url('index.php/admin/editdataruangan/') . $detail_ruangan['id_ruang'] ?>">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="laboratorium" class="form-select" name="laboratorium">
                                                ...
                                                <?php foreach ($laboratorium as $l) : ?>
                                                    <?php if ($l->id_lab == $detail_ruangan['id_lab']) : ?>
                                                        <option value="<?= $l->id_lab ?>" selected><?= $l->nama_lab ?></option>
                                                    <?php else : ?>
